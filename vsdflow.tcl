...
puts "\nConstraints File number of rows = $number_of_rows"
puts "\nConstraints File number of columns = $number_of_columns"
...
puts "\nConstraints File : clock_start = $clock_start"
puts "\nConstraints File : clock_start_column = $clock_start_column"
puts "\nConstraints File : input_ports_start = $input_ports_start"
puts "\nConstraints File : output_ports_start = $output_ports_start"
...
puts "\n"
puts "\n-------------------------------------------------------------------" 
puts "\nInfo-SDC: Input constraints Categorizing and Creation Done....."
puts "\n-------------------------------------------------------------------" 
puts "\n"
puts "\n###################################################################"
puts "\n"
